...
.research-nav a:visited{ color: rgba(255,95,5,.92); } /* avoid purple */
  ...
  /* icons */
  .icon-link{display:inline-flex;align-items:center;gap:.4rem;margin-left: .8rem;}
...
<section id="work-in-progress" class="research-section">
  ...
  <ul class="paper-list">
    <li class="paper-card">
      <p class="paper-title"><b>Off-policy Distributional Reinforcement Learning, M. Mohammadi</b>, Q. Zheng, and R.Zhu</p>
